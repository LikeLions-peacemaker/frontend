  ...
  return (
    <section className="recent-section">
      <div className="card-title-wrap">
        <h2 className="section-title">최근 상담</h2>
        <span className="recent-link">더보기</span>
      </div>
      <div className="consult-card">
        <p className="consult-title">[부동산] 전세 계약 중 집주인이 집을 팔았다고 합니다.</p>
        <p className="consult-time">7시간 전</p>
